        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6">
            <div class="media blog-thumb">
              ...
              <div class="media-body blog-info">
                <small>
                  <i class="fa fa-clock-o"></i> December 22, 2017
                </small>
                <h3>
                  <a href="blog-detail.html">
          ...
          <div class="col-md-6 col-sm-6">
            <div class="media blog-thumb">
              ...
              <div class="media-body blog-info">
                <small>
                  <i class="fa fa-clock-o"></i> December 18, 2017
                </small>
                <h3>
          ...
          <div class="col-md-6 col-sm-6">
            <div class="media blog-thumb">
              ...
              <div class="media-body blog-info">
                <small>
                  <i class="fa fa-clock-o"></i> December 14, 2017
                </small>
                <h3>
          ...
          <div class="col-md-6 col-sm-6">
            <div class="media blog-thumb">
              ...
              <div class="media-body blog-info">
                <small>
                  <i class="fa fa-clock-o"></i> December 10, 2017
                </small>
                <h3>
                  <a href="blog-detail.html">
